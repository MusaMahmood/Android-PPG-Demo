...
internal class PPGData(bufferSize: Int, addressMac: String, uuid: UUID, fileTimestamp: String, samplingRate: Double = 100.0, saveData: Boolean = true, channelNumber: Int=1) :
